...
A 6-part vulgarization series explaining the Oscillating Brane Cosmology V8.0, available in English and French.
...
<div style="text-align: center; margin: 20px 0;">
  ...
  <button id="btn-fr" onclick="switchLang('fr')" style="padding: 10px 25px; margin: 5px; border: 2px solid #ff3366; background: transparent; color: #ff3366; border-radius: 20px; cursor: pointer; font-size: 14px; font-weight: bold;">🇫🇷 Français</button>
</div>
...
function switchLang(lang) {
  document.getElementById('videos-en').style.display = lang === 'en' ? 'block' : 'none';
  document.getElementById('videos-fr').style.display = lang === 'fr' ? 'block' : 'none';
  document.getElementById('btn-en').style.background = lang === 'en' ? '#00ffcc' : 'transparent';
  document.getElementById('btn-en').style.color = lang === 'en' ? '#000' : '#00ffcc';
  document.getElementById('btn-fr').style.background = lang === 'fr' ? '#ff3366' : 'transparent';
  document.getElementById('btn-fr').style.color = lang === 'fr' ? '#fff' : '#ff3366';
}
