...
## The Neutron Lifetime Anomaly: Bottle vs Beam
...
### Preempting the Magnetic Bottle Counter-Argument (UCNtau)

The immediate objection is that the **UCNtau experiment** at Los Alamos National Laboratory, which confines neutrons using Halbach-array magnetic fields with no material walls, still measures a short lifetime ($\tau = 877.75 \pm 0.28$ s) --- apparently invalidating a wall-dependent mechanism.
