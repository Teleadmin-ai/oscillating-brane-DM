  ...
  <div class="key-predictions">
    ...
    <table>
      <tr>
        ...
        <td>$\tau$$_0$ = 7.0 $\times 10^{19}$ J/m²</td>
      </tr>
      <tr>
...
Where:
- $\tau$$_0$ = 7.0 $\times 10^{19}$ J/m² is the brane tension
...
|-------------------|------------------|------------------------|
| Brane tension | $\tau$$_0$ = 7.0 $\times 10^{19}$ J/m² | The elasticity of spatial fabric |
...
| $\tau$$_0$ | 7.0 $\times 10^{19}$ J/m² | The tension maintaining space |
...
$\tau$$_0$ = 2.2 $\times 10^{-5}$ GeV³

Using the conversion: 1 GeV³ = 3.24 $\times 10^{24}$ J/m²
...
$\tau$$_0$ = f_osc M_DM,tot (2$\pi$/T)² = 7.0 $\times 10^{19}$ J/m²
...
In this framework, the brane appears at the Big Bang with quasi-Planckian tension $\tau$_BB ~ $10^{50}$ J/m²—a membrane stretched to breaking point, vibrating with pure energy.
...
**Phase II - Brane Reheating ($10^{-34}$ - $10^{-32}$ s)**: Tension drops abruptly via massive production of dark matter/anti-dark matter pairs in the bulk. This "quantum evaporation" dissipates excess energy, leaving residual tension around $10^{30}$ J/m².
...
| **Direct Detection** | $\sigma$ < $10^{-48}$ cm² forever | $\sigma$ > $10^{-47}$ cm² expected | No prediction |
...
| Brane tension $\tau$$_0$ | 7.0 $\times 10^{19}$ J/m² | ±15% | Indirect via H$_0$(z) | Current |
...
| DM cross-section | < $10^{-48}$ cm² | Lower limit | Direct detection | Current |
...
|-------|-----------|--------------|------------------|--------|------------|
| Oscillating | $\tau$$_0$ | Log-uniform | [$10^{19}$, $10^{20}$] | J/m² | Scale-invariant prior for unknown energy scale |
...
|-----------|------|--------|-----|--------|-----|
| $\tau$$_0$ (J/m²) | 7.08$\times 10^{19}$ | 7.00$\times 10^{19}$ | 1.07$\times 10^{19}$ | [6.03$\times 10^{19}$, 8.13$\times 10^{19}$] | 1.000 |
...
- Stable tension $\tau$$_0$ = 7$\times 10^{19}$ J/m²
...
For a membrane of radius R_H = c/H$_0$ = 1.33 $\times 10^{26}$ m (the Hubble horizon, how far we can see), the deformation energy is:
...
The brane appears at the Big Bang with quasi-Planckian tension $\tau$_BB ~ $10^{50}$ J/m²—a membrane stretched to breaking point, vibrating with pure energy.

### Phase I - Trans-membrane Inflation (0 - $10^{-34}$ s)
...
### Phase II - Brane Reheating ($10^{-34}$ - $10^{-32}$ s)

Tension drops brutally via massive production of dark matter/anti-dark matter pairs in the bulk. This "quantum evaporation" dissipates excess energy, leaving residual tension around $10^{30}$ J/m².
