...
| MOND acceleration | a$_0$ = 1.1 × 10$^{-10}$ m/s$^2$ | Gravity at the edge |
...
a$_0$ = (cH$_0$/2$\pi$) × $\xi$ = 1.1 × 10$^{-10}$ m/s$^2$
...
| **Galactic Scale** |
| MOND a$_0$ | 1.1 × 10$^{-10}$ m/s$^2$ | ±5% | Galaxy dynamics | Current |
...
| Brane tension | $\tau$$_0$ = 7.0 × 10$^1$$^9$ J/m$^2$ | The elasticity of spatial fabric |
| Oscillation period | T = 2.0 ± 0.3 Gyr | The cosmic heartbeat |
| MOND acceleration | a$_0$ = 1.1 × 10$^{-10}$ m/s$^2$ | Gravity at the confines |
...
Early versions imagined dark matter oscillating like a mass on a spring, with energy E $\propto$ z$^2$. This simplistic image led to absurdities: periods shorter than Planck time or stiffnesses exceeding any known physical scale.
...
- A $\simeq$ R_H$^2$: vibrating membrane area (the entire observable universe!)
...
The brane appears at the Big Bang with quasi-Planckian tension $\tau$_BB ~ 10$^5$$^0$ J/m$^2$—a membrane stretched to breaking point, vibrating with pure energy.
...
Tension drops brutally via massive production of dark matter/anti-dark matter pairs in the bulk. This "quantum evaporation" dissipates excess energy, leaving residual tension around 10$^3$$^0$ J/m$^2$.
