...
2024     DESI detects dark energy evolution (4sigma)
   |
2025     S$_{8}$ tension resolved (time-dependent growth suppression)
...
| Fundamental f$_{0}$ | 1.6 x 10$^{-17}$ Hz | +/-10% | ISW in CMB | 2030+ |
| Oscillation period | 2.000 Gyr (eigenvalue) | +/-0.003 Gyr | Large-scale structure | 2028+ |
| ISW amplitude | ~10$^{-5}$ DeltaT/T | Factor of 2 | CMB-S4 | 2030+ |
| **Galactic Scale** |
