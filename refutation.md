...
<div style="text-align: center; margin: 30px 0;">
  <a href="https://github.com/Teleadmin-ai/oscillating-brane-DM/issues/new?template=refutation.yml" style="display: inline-block; padding: 14px 28px; background: linear-gradient(135deg, #ff3366, #00ffcc); color: white; text-decoration: none; border-radius: 25px; font-size: 16px; font-weight: bold;">
    Submit a Scientific Refutation
  </a>
  <span style="margin: 0 15px; color: #666;">or</span>
  <a href="https://github.com/Teleadmin-ai/oscillating-brane-DM/issues/new?template=question.yml" style="display: inline-block; padding: 14px 28px; background: #4a90e2; color: white; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: bold;">
    Ask a Question
  </a>
</div>
...
<div style="text-align: center; margin: 20px 0;">
  <a href="https://github.com/Teleadmin-ai/oscillating-brane-DM/issues?q=is%3Aissue+label%3Arefutation" style="color: #00ffcc;">
