...
def plot_evolution_summary(data, save_path='plots/einstein_2d_summary.png'):
    ...
    ax1.text(0.02, 0.95, f'Period: T = {data["period_measured"]:.1f} (expected: 12.57)',
    ...
    ax4.text(0.98, 0.95, '⚠ Numerical drift present\nRequires improved integrator',
             transform=ax4.transAxes, fontsize=9, verticalalignment='top',
             horizontalalignment='right',
             bbox=dict(boxstyle='round', facecolor='yellow', alpha=0.7))
    
    plt.suptitle('2D Prototype: 5D Einstein Equations with Oscillating Brane', fontsize=14)
...
def create_results_table(data, save_path='docs/einstein_2d_table.tex'):
    ...
    lines.append(f"Warp factor modulation & {data['warp_modulation']*100:.0f}\\% & -- \\\\")
