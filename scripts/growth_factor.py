...
class GrowthFactorCalculator:
    ...
    def __init__(self, omega_m: float = Omega_m0, 
    ...
    def E_z(self, z: np.ndarray) -> np.ndarray:
        ...
        if self.oscillating:
            ...
            f_interp = interp1d(z_int, rho_de_ratio, 
    ...
    def calculate_growth_factor(self, z: np.ndarray, 
        ...
        if exact:
            ...
            g = 5/2 * self.omega_m * (
                self.omega_m**(4/7) - self.omega_de + 
...
def main():
    ...
    parser.add_argument(
        '--compare',
        action='store_true',
        help='Compare oscillating vs ΛCDM cosmology'
    )
