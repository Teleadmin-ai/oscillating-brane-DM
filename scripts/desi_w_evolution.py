...
ax.set_title(
    "Dark Energy Evolution: Oscillating Brane vs ΛCDM\n(Resolving the DESI 2024 Anomaly)",
    fontsize=16,
    color="white",
    pad=20,
)
...
# Save the figure
plt.savefig(
    "/root/bulk/oscillating-brane-DM/plots/desi_w_evolution.png",
    dpi=150,
    bbox_inches="tight",
    facecolor="black",
)
